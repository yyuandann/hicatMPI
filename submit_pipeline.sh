...
out_dir="/path/to/out_dir" # an 'out' folder will be created
n_nodes_mpi=10
mem=500G

# Hard-coded kwargs here
# The following are the default parameters for the clustering. Change as needed.
clust_kwargs="{
    'means_vars_kwargs': {
...
echo "Submitted final_merging.sh as job $merge_jobid (afterok:$mpi_jobid)"
